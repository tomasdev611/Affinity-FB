...
@Component({
  selector: 'app-master-list-counties',
  templateUrl: './county.component.html',
  styleUrls: ['./county.component.scss']
})
export class CountyMasterListComponent implements OnInit {
  ...
  addNewData() {
    this.store.dispatch(new CreateCommonData({target: 'counties', data: this.editData}));
  }
