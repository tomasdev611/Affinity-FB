...
const OMIT_FIELDS = [...COMMON_OMIT_FIELD, 'SkillId'];

@Component({
  selector: 'app-master-list-skill',
...
export class SkillMasterListComponent implements OnInit {
  ...
  addNewData() {
    this.store.dispatch(new CreateCommonData({target: 'skills', data: this.editData}));
  }
