...
@Component({
  selector: 'app-client-exclusion-preferences',
  templateUrl: './exclusion-preferences.component.html',
  styleUrls: ['./exclusion-preferences.component.scss']
})
export class ExclusionPreferencesComponent implements OnInit {
  clientDetail: any;
  ClientId: string;
  saving: string = '';
