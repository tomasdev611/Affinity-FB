...
@Component({
  selector: 'app-client-supervisory-visits',
  templateUrl: './supervisory-visits.component.html',
  styleUrls: ['./supervisory-visits.component.scss']
})
export class SupervisoryVisitsComponent implements OnInit {
  clientDetail: any;
  ClientId: string;
  saving: string = '';
