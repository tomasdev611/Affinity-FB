...
@Component({
  selector: 'app-client-interruptions-service',
  templateUrl: './interruptions-service.component.html',
  styleUrls: ['./interruptions-service.component.scss']
})
export class InterruptionsServiceComponent implements OnInit {
  clientDetail: any;
  ClientId: string;
  saving: string = '';
