...
@Component({
  selector: 'app-client-directions-misc',
  templateUrl: './directions-misc.component.html',
  styleUrls: ['./directions-misc.component.scss']
})
export class DirectionsMiscComponent implements OnInit {
  clientDetail: any;
  ClientId: string;
  saving: string = '';
